...
urlpatterns = [
    ...
    path('main_page/family/remove/<int:member_id>/', views.family_unlink, name='family_remove'),
    path('main_page/family/leave/<int:admin_id>/', views.family_unlink, name='family_leave'),
